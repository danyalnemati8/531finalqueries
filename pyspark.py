...
# spark.conf.set("spark.jars", "/path/to/spark-bigquery-latest.jar")
...
part_df = spark.read.format("csv") \
    .option("delimiter", "|") \
    .schema(part_schema) \
    .load("gs://tcp_1gb/archive/tcp-h/part.tbl")
...
supplier_df = spark.read.format("csv") \
    ...
    .load("gs://tcp_1gb/archive/tcp-h/supplier.tbl")
...
partsupp_df = spark.read.format("csv") \
    ...
    .load("gs://tcp_1gb/archive/tcp-h/partsupp.tbl")
...
customer_df = spark.read.format("csv") \
    ...
    .load("gs://tcp_1gb/archive/tcp-h/customer.tbl")
...
order_df = spark.read.format("csv") \
    .option("delimiter", "|") \
    .schema(order_schema) \
    .load("gs://tcp_1gb/archive/tcp-h/orders.tbl")
...
lineitem_df = spark.read.format("csv") \
    ...
    .load("gs://tcp_1gb/archive/tcp-h/lineitem.tbl")
# # Saving to BigQuery
...
nation_df = spark.read.format("csv") \
    ...
    .load("gs://tcp_1gb/archive/tcp-h/nation.tbl")
...
region_df = spark.read.format("csv") \
    ...
    .load("gs://tcp_1gb/archive/tcp-h/region.tbl")